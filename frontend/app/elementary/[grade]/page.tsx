...
import { getSubjectsByGradeElementary } from "@/lib/data";
...
export default async function ElementaryGradePage({ params }: Props) {
  ...
  try {
    subjects = await getSubjectsByGradeElementary(gradeLevel);
  } catch {
    notFound();
  }
  ...
  return (
    <div className="max-w-3xl mx-auto px-4 py-6">
      <div className="mb-6">
        ...
        <h1 className="text-2xl font-black text-gray-800">小学{gradeLevel}年</h1>
